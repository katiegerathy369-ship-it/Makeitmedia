...
export default function PractitionersContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('form-name', 'practitioner-contact')
    ...
    >
      ...
      <div className="max-w-container mx-auto px-12 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[100px] items-center">
          ...
          >
            <p className="text-[11px] font-medium tracking-[0.12em] uppercase mb-4" style={{ color: 'var(--sage-light)' }}>
              Let's talk
            </p>
            <h2
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 text-[14px] font-light" style={{ color: 'rgba(255,255,255,0.75)' }}>
                ...
                <a href="mailto:kate@makeitmedia.io" style={{ color: 'var(--sage-light)', textDecoration: 'none' }} className="hover:underline">
                  kate@makeitmedia.io
                </a>
              </div>
              <div className="flex items-center gap-3 text-[14px] font-light" style={{ color: 'rgba(255,255,255,0.75)' }}>
          ...
          >
            ...
            >
              <input type="hidden" name="form-name" value="practitioner-contact" />
              <div className="hidden"><label>Don&apos;t fill this out: <input name="bot-field" /></label></div>

              <div className="grid grid-cols-2 gap-4 mb-5">
                <div>
                  <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>First name</label>
                  <input type="text" name="firstName" value={form.firstName} onChange={handleChange} placeholder="Sarah" className={inputBase} required />
                </div>
                <div>
                  <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>Last name</label>
                  <input type="text" name="lastName" value={form.lastName} onChange={handleChange} placeholder="Mitchell" className={inputBase} required />
                </div>
              </div>

              <div className="mb-5">
                <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>Email</label>
                <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="hello@yourpractice.com.au" className={inputBase} required />
              </div>

              <div className="mb-5">
                <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>Phone</label>
                <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="04XX XXX XXX" className={inputBase} required />
              </div>

              <div className="mb-5">
                <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>What type of practitioner are you?</label>
                <select name="practiceType" value={form.practiceType} onChange={handleChange} className={`${inputBase} form-select-custom cursor-pointer`} required>
              ...
              <div className="mb-5">
                <label className="block text-[12px] font-medium tracking-[0.06em] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.5)' }}>Tell me about your practice</label>
                <textarea name="message" value={form.message} onChange={handleChange} placeholder="What does your practice focus on? What are you hoping to achieve with your website?" className={`${inputBase} resize-y min-h-[110px]`} required />
              </div>

              <button
                type="submit"
                disabled={submitted}
                id="cta-practitioner-contact-submit"
