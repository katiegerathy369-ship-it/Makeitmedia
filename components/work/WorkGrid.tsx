...
export const PROJECTS: Project[] = [
  {
    ...
    fullWidth: true,
    href: '/work/amy-angus',
    browserUrl: 'amyangusnaturopathy.com.au',
    previewVariant: 'amy',
    ...
    practice: 'Naturopath · Brisbane, QLD · Tier 1 - Presence package',
    pills: [
    ...
    screenshot: '/images/portfolio/amy-angus-naturopathy/desktop-after/preview-screenshot.png',
  },
  {
