...
export const metadata: Metadata = {
  title: 'Naturopath Website Design Australia | Make It Media',
  description:
    ...
    <html lang="en" className={`${cormorant.variable} ${dmSans.variable}`}>
      <body>
        ...
        <Script id="cal-embed" strategy="lazyOnload">{`
          ...
          Cal.ns.strategycall("ui", {"theme":"light","cssVarsPerTheme":{"light":{"cal-brand":"#2d5a3d"},"dark":{"cal-brand":"#edf4ef"}},"hideEventTypeDetails":false,"layout":"month_view"});
        `}</Script>
      </body>
    </html>
  )
